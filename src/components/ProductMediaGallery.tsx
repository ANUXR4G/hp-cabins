...
export default function ProductMediaGallery({ title, category, badge, images, productId = '' }: Props) {
  ...
  return (
    <div className="space-y-4">
      <div className="relative h-96 sm:h-[480px] bg-gray-100 rounded-none overflow-hidden border border-gray-200">
        <img
        ...
        <div className="flex gap-2 overflow-x-auto no-scrollbar pb-1">
          {gallery.map((img, idx) => (
            <button
              ...
              className={`h-16 w-24 shrink-0 rounded-none overflow-hidden border-2 transition-all duration-300 ${
                activeImg === idx
                  ? 'border-crimson scale-95'
