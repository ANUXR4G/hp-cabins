...
export default function PropertyCard({ property }: PropertyCardProps) {
  ...
  return (
    <div className="group flex flex-col bg-white rounded-2xl overflow-hidden border border-gray-200/80 shadow-sm luxury-card hover:border-crimson/50 transition-all duration-300">
      ...
      <div className="relative h-60 overflow-hidden bg-gray-100">
        ...
        <div className="absolute top-4 left-4 flex flex-col gap-2 z-10">
          <span className="bg-black/75 backdrop-blur-md text-white border border-white/10 text-[9px] font-bold tracking-wider uppercase px-2.5 py-1 rounded-lg">
            {property.category}
          </span>
          <span className="bg-crimson text-white text-[8px] font-extrabold tracking-wider uppercase px-2.5 py-0.5 rounded-md shadow-sm">
            {property.badge}
          </span>
        </div>
        <div className="absolute bottom-4 left-4 z-10">
          <span className="bg-black/85 text-white font-serif font-bold text-sm py-1 px-3 rounded-lg border border-white/15">
            {property.developer}
          </span>
        </div>
      </div>
      ...
      <div className="p-6 flex-grow flex flex-col justify-between">
        ...
        <div>
          {/* Specs */}
          <div className="grid grid-cols-3 gap-2 border-t border-gray-100 pt-4 pb-4 mb-4 text-gray-600 text-[10px] sm:text-[11px]">
          ...
          <div className="pt-1 border-t border-gray-100">
            <Link
              ...
              className="text-sm font-extrabold text-crimson hover:underline"
            >
              View Details
            </Link>
          </div>
