...
export default function FloatingElements() {
  ...
  return (
    <>
      ...
      {isWidgetOpen && (
        <div className="fixed right-5 sm:right-6 bottom-24 z-50 w-[min(calc(100%-2.5rem),20rem)] sm:w-80 bg-white/90 backdrop-blur-md border border-gray-200/80 rounded-none p-5 text-premium-black animate-fade-in flex flex-col space-y-4">
          ...
          <div className="flex items-center justify-between border-b border-gray-100 pb-3">
            ...
            <button 
              ...
              className="p-1 hover:bg-gray-100 rounded-none text-gray-400 hover:text-crimson transition-colors cursor-pointer"
            >
              <X className="w-4 h-4" />
            </button>
          </div>
            ...
            {formSubmitted ? (
              ...
              <form onSubmit={handleFormSubmit} className="space-y-2 text-xs">
                ...
                <button 
                  ...
                  className="w-full btn-label text-white py-2.5 px-3 rounded-none flex items-center justify-center gap-1.5 transition-all cursor-pointer bg-crimson"
      ...
      <div className="fixed right-5 sm:right-6 bottom-6 flex flex-col gap-3.5 z-40 items-end">
        ...
        <button
          ...
          className="flex items-center justify-center w-14 h-14 bg-crimson text-white rounded-full hover:scale-110 active:scale-95 transition-all duration-300 relative group cursor-pointer"
          style={{ backgroundColor: accentColor }}
        ...
        {showScrollTop && (
          <button
            ...
            className="flex items-center justify-center w-10 h-10 bg-white hover:bg-gray-50 border border-gray-150 text-premium-black rounded-full hover:scale-110 active:scale-95 transition-all duration-300 cursor-pointer animate-fade-in"
            title="Scroll to Top"
          >
