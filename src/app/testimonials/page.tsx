    ...
    <div className="bg-[#F5F5F5] min-h-screen pb-24 font-sans text-premium-black">
      ...
      <div className="relative bg-premium-black py-16 text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4">
          <h1 className="text-3xl font-extrabold text-white font-serif tracking-wide">Testimonials</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10">
        <div className="text-center max-w-3xl mx-auto mb-12 space-y-3">
          <span className="uppercase tracking-widest text-[10px] font-extrabold text-crimson block">
            Client Testimonials
          </span>
